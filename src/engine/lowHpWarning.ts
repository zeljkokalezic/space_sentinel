/**
 * lowHpWarning.ts — Low HP warning system.
 *
...
export interface LowHpWarningLevel {
  active: boolean;
  level: 0 | 1 | 2;
  isCritical: boolean;
  intensity: number;
...
interface LowHpWarningGameState {
  player?: {
    hp: number;
    maxHp: number;
  };
  lowHpWarning?: LowHpWarningState | null;
}
 ...
 */
export const getLowHpWarningLevel = (hp: number, maxHp: number): LowHpWarningLevel => {
 ...
 */
export const updateLowHpWarning = (dt: number, g: LowHpWarningGameState): void => {
