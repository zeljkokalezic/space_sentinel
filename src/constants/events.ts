...
export interface EventGameRef {
  current: EventGameState;
}

export interface EventRelicReward {
  rarity: RelicRarity;
}

export interface EventChoice {
  text: string;
  relicReward?: EventRelicReward;
  condition?: (gameRef: EventGameRef) => boolean;
  resolve: (gameRef: EventGameRef) => void;
}
...
export const EVENTS_DATA: SpaceEvent[] = [
  {
