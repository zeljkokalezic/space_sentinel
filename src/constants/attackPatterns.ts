/**
 * attackPatterns.ts — Boss attack pattern function library.
 *
 ...
 */
export const single_aimed: AttackPattern = (g, boss, angle, damage, speed) => {
 ...
 */
export const spread_shot: AttackPattern = (g, boss, angle, damage, speed) => {
  const count = 3;
  const spread = 0.3;
 ...
 */
export const spiral_barrage: AttackPattern = (g, boss, angle, damage, speed) => {
  for (let i = 0; i < 3; i++) {
 ...
 */
export const burst_ring: AttackPattern = (g, boss, _angle, damage, speed) => {
  for (let i = 0; i < 8; i++) {
 ...
 */
export const double_aimed: AttackPattern = (g, boss, angle, damage, speed) => {
 ...
 */
export const wide_spread: AttackPattern = (g, boss, angle, damage, speed) => {
  const count = 7;
  const spread = 0.5;
  for (let i = 0; i < count; i++) {
    const a = angle - spread + (i / (count - 1)) * spread * 2;
 ...
 */
export const zigzag_spread: AttackPattern = (g, boss, angle, damage, speed) => {
  for (let i = 0; i < 5; i++) {
 ...
 * Updates boss.spiralAngle for next call.
 */
export const orbiting_mines: AttackPattern = (g, boss, _angle, damage, speed) => {
  for (let i = 0; i < 6; i++) {
 ...
 */
export const homing_burst: AttackPattern = (g, boss, angle, damage, speed) => {
  for (let i = 0; i < 3; i++) {
 ...
 */
export const delayed_burst: AttackPattern = (g, boss, _angle, damage, speed) => {
