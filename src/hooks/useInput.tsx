/**
 * hooks/useInput.tsx — Keyboard and pointer event handlers.
 *
...
interface UseInputArgs {
  game: GameRef;
  threeRef: RefObject<ThreeScene | null>;
  gameState: GameStateName;
  statusRef: { current: GameStateName };
  setGameState: (state: GameStateName | ((prev: GameStateName) => GameStateName)) => void;
  setDevMode: (updater: ((dm: boolean) => boolean) | boolean) => void;
  startGame: () => void;
